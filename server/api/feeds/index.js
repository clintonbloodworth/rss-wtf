...
module.exports = async (request, response) => {
  ...
  // TODO: think about what to do with an feed that
  // changes from HTTP to HTTPS or vice versa.
  feeds = feeds
    .map(feed => {
      return {
        color: getColor(isDirectRequest ? request.query.url : feed.url),
        // Namespacing and conflicts feel like the biggest
        // problems to me right now. Why can't block statements
        // be expressions? Hm?
        favicon: (() => {
