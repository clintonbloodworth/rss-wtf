...
<style>
  ...
  .router {
    ...
    &::after {
      background: linear-gradient(180deg, var(--color-border) var(--border-width), var(--color-background) 1px);
      content: "";
      display: block;
      flex-shrink: 0;
    ...
    &::before {
      background: linear-gradient(0deg, var(--color-border) var(--border-width), var(--color-background) 1px);
      content: "";
      display: block;
      flex-shrink: 0;
